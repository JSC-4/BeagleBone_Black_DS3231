/*
 ...
 Name        : DS3231.c
 Author      : JSC
 Website	 : https://www.jscblog.com/post/beagleboneblack-ds3231
 Description : This project is to communicate with the DS3231 using the BeagleBone Black.
 	 	 	   The code was adapted from the book "Exploring BeagleBone", by Derek Molloy.
 	 	 	   It includes functions to set and call the data and time as well as
